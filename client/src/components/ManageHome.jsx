    ...
    <div>
      <main className={classes.mainContent}>
        <div className={classes.cardContainer}>
          <div onClick={() => navigate("/mng/rentals")} className={classes.card}>
            <span
              style={{ color: "green" }}
          ...
          <div onClick={() => navigate("/mng/archive")} className={classes.card}>
            <span
              style={{ color: "orange" }}
              className={`${classes.cardIcon} material-symbols-outlined`}
            >
          ...
          <div
            onClick={() => navigate("/mng/access-numbers")}
          ...
          <div className={classes.card} onClick={() => navigate("/mng/il-numbers")}>
            <span
              style={{ color: "grey" }}
              className={`${classes.cardIcon} material-symbols-outlined`}
            >
          ...
          <div
            onClick={() => navigate("/mng/sim-activation")}
            className={classes.card}
          >
            <span
              style={{ color: "blue" }}
